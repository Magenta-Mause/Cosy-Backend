...
public final class WebSocketDestinations {
    ...
    public static final class Topics {
        ...
        public static final String PUBLIC_GAME_SERVER_UPDATES =
                BROKER_PREFIX + "/public/game-servers/updates/{serverId}";
        public static final String PUBLIC_GAME_SERVER_LOGS =
                BROKER_PREFIX + "/public/game-servers/{serverId}/logs";
        public static final String PUBLIC_GAME_SERVER_METRICS =
                BROKER_PREFIX + "/public/game-servers/{serverId}/metrics";
    }
}
