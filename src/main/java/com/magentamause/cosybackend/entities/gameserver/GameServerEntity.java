...
public class GameServerEntity {
        ...
        @CollectionTable(name = "docker_execution_command", joinColumns = @JoinColumn(name = "game_server_configuration_uuid"))
        @Column(name = "command_part")
        private List<String> dockerExecutionCommand;

        @ElementCollection(fetch = FetchType.EAGER)
        @CollectionTable(name = "port_mappings", joinColumns = @JoinColumn(name = "game_server_configuration_uuid"))
        private List<PortMapping> portMappings;

        @ElementCollection(fetch = FetchType.EAGER)
        @CollectionTable(name = "environment_variables", joinColumns = @JoinColumn(name = "game_server_configuration_uuid"))
        ...
        public GameServerDto toDto(UserEntity user) {
                List<GameServerAccessPermission> permissions = GameServerFieldVisibilityPolicy.resolvePermissions(this,
                                user);
