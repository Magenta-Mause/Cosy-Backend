...
public class GameServerPolicy {
    ...
    public boolean deleteGameServer(
            ResourceResolver resourceResolver, Object referenceId, UserEntity user) {
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.DELETE_SERVER);
    }

    @Validates(Operation.GAME_SERVER_START_STOP)
    public boolean startStopGameServer(
            ResourceResolver resourceResolver, Object referenceId, UserEntity user) {
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.START_STOP_SERVER);
    }

    @Validates(Operation.GAME_SERVER_UPDATE)
    public boolean updateGameServer(
            ResourceResolver resourceResolver, Object referenceId, UserEntity user) {
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.CHANGE_SERVER_CONFIGS);
    }
    ...
    public boolean getGameServer(
        ...
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.SEE_SERVER);
    }
    ...
    public boolean sendCommandToGameServer(
            ResourceResolver resourceResolver, Object referenceId, UserEntity user) {
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.SEND_COMMANDS);
    }

    @Validates(Operation.GAME_SERVER_GET_LOGS)
    public boolean getGameServerLogs(
            ResourceResolver resourceResolver, Object referenceId, UserEntity user) {
        return IS_GAMESERVER_OWNER_OR_HAS_PERMISSION(resourceResolver, referenceId, user, GameServerAccessPermission.READ_SERVER_LOGS);
    }
}
